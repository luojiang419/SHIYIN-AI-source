    ...
    if prompt_policy == LOOKBOOK_PROMPT_POLICY:
        ...
        if effective_style_id in {"", "candid-lifestyle", "single-person-emotion", "casual-friends", "travel-dream", "pet-fashion"}:
            ...
            parts.extend([
                ...
                "HUMAN PERFORMANCE AND GROOMING: give every frame one external objective that belongs to the scene—arriving somewhere, selecting a newspaper or magazine, reacting to an off-frame person or sound, paying, leaving, sheltering from weather or handling a supplied object. Direct the body in the middle of that task: eyes follow the objective, fingers form a functional grip, shoulders and hips counterbalance, weight transfers between feet and clothing responds to momentum. Emotion is the involuntary reaction inside the task, never a beauty pose; keep hands occupied by the object, bag or environment instead of touching hair, chest or face. Preserve the supplied identity, face shape, skin tone, pores, hairline, hair texture, body proportions, visible makeup and wardrobe exactly. Use tactile strands, clean but human skin, minimal corrective makeup and weather-appropriate hair movement; do not invent a new face, freckles, scars, age cues or beauty filter.",
