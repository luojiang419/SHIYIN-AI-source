    ...
    if prompt_policy == LOOKBOOK_PROMPT_POLICY:
        ...
        if effective_style_id in {"", "candid-lifestyle", "single-person-emotion", "casual-friends", "travel-dream", "pet-fashion"}:
            ...
            parts.extend([
                ...
                "FW NATURAL SUN TRANSPARENCY: light must feel like real unfiltered afternoon sun entering the lens—visible warm directionality, gently blooming sunlit edges, translucent hair and fabric, airy atmospheric separation, natural specular glints and soft-edged cast shadows with a cool sky-bounce fill on the shadow side. Expose for luminous whites without bleaching the scene; keep the air clear and the colors open. Do not simulate this with a beige overlay, studio softbox, flat ambient fill, foggy milk wash or artificial rim-light effect.",
                ...
                "FW HUMAN VITALITY LOCK: direct an internal emotional beat and a small physical action in every frame. Use reclining, leaning, turning, looking down or away, briefly closing the eyes, a soft unforced smile, fingers resting on a rail, adjusting a knit, tracing a fabric edge, shifting weight or taking a half-step. Let breath, gaze, eyelids, mouth corners, shoulder release and hand tension carry the mood; preserve micro-asymmetry and spontaneous timing. An ordinary, imperfect face is welcome: keep freckles, pores, flyaway hair, uneven smile and small skin asymmetries when present. Natural is more luxurious than airbrushed perfection; never pose for a storefront catalog.",
                "FW ANALOG FINISH: retain skin pores, stray hair, knit loops, lace holes, seams and hardware. Add genuinely irregular coarse film grain—not a regular grid, checkerboard, repeating dots or uniform digital noise—using visible clumps of different sizes, random spacing, slight density variation across the frame and tiny non-uniform RGB response that is stronger in midtones/shadows and gentler in highlights. Keep motion softness natural, sharpening low and halation very restrained. Reject plastic skin, waxy fabric, AI gloss, crunchy HDR, crushed blacks, clipped whites, excessive clarity and fake vignette.",
