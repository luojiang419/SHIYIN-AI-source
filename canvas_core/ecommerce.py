    ...
    if prompt_policy == LOOKBOOK_PROMPT_POLICY:
        ...
        if effective_style_id in {"", "candid-lifestyle", "single-person-emotion", "casual-friends", "travel-dream", "pet-fashion"}:
            ...
            parts.extend([
                ...
                "FW HUMAN VITALITY LOCK: direct an internal emotional beat and a small physical action in every frame. Use reclining, leaning, turning, looking down or away, briefly closing the eyes, a soft unforced smile, fingers resting on a rail, adjusting a knit, tracing a fabric edge, shifting weight or taking a half-step. Let breath, gaze, eyelids, mouth corners, shoulder release and hand tension carry the mood; preserve micro-asymmetry and spontaneous timing. The subject must feel alive and caught between actions, never posing for a storefront catalog.",
                "FW ANALOG FINISH: retain skin pores, stray hair, knit loops, lace holes, seams and hardware. Add fine organic 16mm/35mm film grain with delicate visible grain clumps, restrained print-scan texture and a very slight warm halation only on bright edges; keep motion softness natural and sharpening low. Reject plastic skin, waxy fabric, AI gloss, crunchy HDR, crushed blacks, clipped whites, excessive clarity and fake vignette.",
