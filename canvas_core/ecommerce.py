    ...
    if prompt_policy == LOOKBOOK_PROMPT_POLICY:
        ...
        if effective_style_id in {"", "candid-lifestyle", "single-person-emotion", "casual-friends", "travel-dream", "pet-fashion"}:
            ...
            parts.extend([
                ...
                "DOCUMENTARY CAMERA: use a human eye-level or waist-level handheld viewpoint with natural perspective. Build a series from a 28mm environmental establishing frame, a 50mm observed action frame, an 85mm intimate emotion or material frame and one tactile contact detail. Vary horizon, distance, crop and foreground occlusion with purpose; use doorways, windows, rails, vehicles, furniture, plants or garment edges as real framing elements. Keep feet grounded and match perspective, ambient color and contact shadows so the person belongs inside the supplied location.",
                "HUMAN PERFORMANCE AND GROOMING: direct a real internal beat and a small physical action—walking, turning mid-step, leaning, sitting, reaching, adjusting denim, holding a supplied object, listening, laughing between words, looking away or taking a breath. Let gaze, eyelids, mouth corners, shoulder release, hand tension and weight shift carry emotion; never use a rigid e-commerce stance. Preserve the supplied identity, face shape, skin tone, pores, hairline, hair texture, body proportions, visible makeup and wardrobe exactly. Use tactile strands, clean but human skin, minimal corrective makeup and weather-appropriate hair movement; do not invent a new face, freckles, scars, age cues or beauty filter.",
