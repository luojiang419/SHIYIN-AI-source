...
PROFILES = {
    'minimax-h3': {'title': 'MiniMax H3', 'limit': 7000,
        'source': 'https://github.com/MiniMax-AI/MiniMax-H3', 'kind': 'official-skill'},
    'kling-cli': {'title': 'Kling VIDEO 3.0 / 3.0 Omni', 'limit': 2500,
        'source': 'https://kling.ai/quickstart', 'kind': 'official-guide-derived-adapter'},
