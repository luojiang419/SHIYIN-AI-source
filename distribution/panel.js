...
const names={hot:'应用增量包','hot-depth-batch':'批量深度提取器增量包','hot-bootstrap':'更新器引导包','hot-updater':'更新器修复包',full:'全量安装包','person-depth':'人物深度组件','video-depth':'深度视频模型','video-depth-runtime':'深度视频运行时'};
...
const resourceIcons={hot:'PackageOpen','hot-depth-batch':'Boxes','hot-bootstrap':'RefreshCw','hot-updater':'Zap',full:'AppWindow','person-depth':'ScanFace','video-depth':'FileVideo','video-depth-runtime':'Cpu'};
const releaseGroups=[
  {id:'application',title:'应用热更新',description:'面向日常功能发布的应用增量包',kinds:['hot','hot-depth-batch']},
