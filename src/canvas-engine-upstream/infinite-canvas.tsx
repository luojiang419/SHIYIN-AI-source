...
import { canvasThemes, type CanvasBackgroundMode } from "./canvas-theme";
...
export function InfiniteCanvas({ containerRef, viewport, tool, panButton, backgroundMode = "lines", onViewportChange, onCanvasMouseDown, onCanvasDeselect, onCanvasDoubleClick, onContextMenu, onDrop, children }: InfiniteCanvasProps) {
    ...
    const handlePointerDown = (event: React.PointerEvent<HTMLDivElement>) => {
        ...
        if (event.button === 0 && isBackgroundClick && onCanvasMouseDown) {
            event.preventDefault();
            event.currentTarget.setPointerCapture(event.pointerId);
    ...
    return (
        <div
            ...
            style={{ background: theme.canvas.background, cursor, position: "relative", width: "100%", height: "100%", overflow: "hidden" }}
        ...
        >
            ...
            <div
                id="world"
                className="world absolute origin-top-left"
