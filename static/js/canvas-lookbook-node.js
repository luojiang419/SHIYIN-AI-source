(function(){
    ...
    function resetDerivedResearch(node){ Object.assign(node,{lookbookPlan:'',lookbookResearch:'',lookbookReferenceAnalysis:'',lookbookVisualSystem:{},lookbookAutoDecision:{},lookbookContextSignature:'',lookbookResearchSources:[],lookbookResearchImages:[],lookbookResearchQueries:[],lookbookResearchDirection:{},lookbookResearchShots:[],lookbookResearchEvidenceStatus:'',lookbookResearchStatus:'idle',lookbookAgentStage:''}); }
    ...
    function normalize(node){
        ...
        node.lookbookSearch=node.lookbookSearch!==false;
        ...
        node.count=clamp(node.count||4,1,4);
