(function(){
    ...
    const STYLES = [
        {id:'fw-cream-cyan-film',name:'2026 FW 奶油青蓝胶片抓拍',description:'结构化高键光比、奶油黄与青蓝互补色、不规则胶片颗粒和真实人物微动作',prompt:'2026 FW fashion-film visual system derived from the supplied reference images: real unfiltered afternoon sunlight with clear airy transparency, warm directional highlights, translucent hair and fabric, natural specular glints and soft-edged cast shadows opened by cool sky bounce. Expose as a luminous high-key daylight photograph with a confident structured S-curve: keep a small true black anchor in dark hair, deep interiors, rail gaps and hardware; separate the sunlit subject/garment plane from the darker environment plane; open faces and cream fabric without turning the whole frame gray or milky. Use warm ivory, cream and pale lemon-yellow as the dominant palette, turquoise and faded cyan architectural accents as the controlled complement, warm-neutral truthful skin, readable blacks, separated midtones and a short creamy highlight shoulder. High-key means luminous exposure with deliberate contrast, never a flat low-contrast wash, foggy milk veil, HDR crunch or random hue shift. For 16:9 outputs, use a clear brightest plane, a darker framing plane and one intentional negative-space area; keep the subject off-center, with a slightly tilted horizon or foreground rail/doorframe/fabric occlusion when motivated. Use the supplied scene as the exact set—preserve its recognizable geometry, dominant paint colors, storefront or kiosk details and printed graphics; change only camera position, crop and natural exposure, never relocate to a beach, cafe, generic street or studio. Use the USER-SUPPLIED MODEL as the sole identity source and preserve the supplied face, skin tone, visible pores, marks, hairline and natural asymmetries exactly; do not add freckles, moles, scars, wrinkles, makeup or other facial traits that are not visible in the user image. Photograph the supplied person, product and scene as one lived-in world with eye- or waist-height handheld perspective, alternating environmental wide, oblique medium, intimate expression and tactile detail. Direct relaxed micro-actions—reclining, leaning, turning, looking down, eyes briefly closed, soft smile, resting a hand, adjusting knit or touching the environment—so emotion reads through breath, gaze, fingers and weight shift instead of a catalog pose. Finish with a fine-to-medium, point-like and emulsional 16mm/35mm film grain: irregular individual grains with random spacing, tiny density variation and subtle non-uniform RGB response, stronger in midtones/shadows and gentler in highlights. Keep the grains separate and organic; never create large connected blotches, cloudy patches, dirty stains, mottled islands, regular grid, checkerboard, repeating dots or uniform digital noise. Add restrained print-scan texture and barely perceptible warm halation only on bright edges; ignore any captions, credits, slogans or logos visible in style references and generate no text. Keep sharpening low and motion softness natural. Each generated output is one full-bleed photograph only; never a contact sheet, grid, split screen, storyboard or collage. Keep a four-image arc across separate outputs: sunlit establishing place, observed gesture, private pause, tactile fabric/product proof; change distance and decisive moment while maintaining the same light and color script.'},
