(function(){
    ...
    window.StudioI18n.register({
        ...
        "smart.engineComfy": { zh: "本地生成已停用", en: "Local generation disabled" },
        ...
        "smart.batchProcess": { zh: "批量处理", en: "Batch Process" },
        "smart.batchProcessing": { zh: "批量处理中", en: "Batch Processing" },
        "smart.batchHint": { zh: "每张输入图片独立执行同一提示词与参数", en: "Run the same prompt and settings on every input image independently" },
        "smart.batchNeedsImages": { zh: "请至少连接一张图片", en: "Connect at least one image" },
        "smart.batchPromptPlaceholder": { zh: "例如：移除画面中的人物并自然补全背景", en: "Example: remove people and naturally reconstruct the background" },
        ...
        "smart.createPromptSub": { zh: "手写或用 AI助手生成文本", en: "Write text or generate it with the AI Assistant" },
        ...
        "smart.comfyMode": { zh: "本地生成模式", en: "Local generation mode" },
        "smart.upscaleTarget": { zh: "超分目标", en: "Upscale Target" },
        "smart.workflow": { zh: "工作流", en: "Workflow" },
        "smart.noWorkflow": { zh: "本地生成已停用", en: "Local generation disabled" },
        ...
        "smart.promptLlmInstructionPlaceholder": { zh: "输入给 AI助手的文本，运行后会写入上方提示词", en: "Text sent to the AI Assistant. The result will be written into the prompt above." },
        ...
        "smart.promptLlmNeedText": { zh: "请先输入给 AI助手的文本", en: "Enter text for the AI Assistant first" },
        ...
        "smart.mentionAssets": { zh: "素材库", en: "Assets" },
        ...
        "smart.errNeedWorkflow": { zh: "本地生成已停用，请改用在线 API 生成", en: "Local generation is disabled. Use an online API instead" },
        "smart.errComfyNoImages": { zh: "本地生成已停用，请改用在线 API 生成", en: "Local generation is disabled. Use an online API instead" },
        "smart.errComfyEmpty": { zh: "本地生成已停用，请改用在线 API 生成", en: "Local generation is disabled. Use an online API instead" },
        ...
        "smart.slotGenerating": { zh: "生成中", en: "Generating" },
        "smart.slotFailed": { zh: "此张生成失败", en: "This image failed" },
        "smart.slotFailedHint": { zh: "失败位置已保留，可原位重试", en: "Failed positions are preserved for in-place retry" },
        "smart.retrySlot": { zh: "重试", en: "Retry" },
        "smart.querySlot": { zh: "查询", en: "Check" },
        "smart.deleteSlot": { zh: "删除", en: "Delete" },
        ...
        "smart.assetLibrary": { zh: "素材库", en: "Assets" },
        "smart.assetImages": { zh: "服装素材", en: "Images" },
        "smart.assetWorkflows": { zh: "素材", en: "Assets" },
        ...
        "smart.assetDropHint": { zh: "把画布图片拖到这里保存为服装素材", en: "Drop canvas images here to save them" },
        "smart.assetEmpty": { zh: "这个分组还没有服装素材。把画布里的商品图拖进来保存。", en: "No images here yet. Drag images from the canvas into this folder." },
        "smart.assetWorkflowEmpty": { zh: "暂无素材", en: "No assets" },
        "smart.assetRename": { zh: "重命名", en: "Rename" },
        "smart.assetDeleteConfirm": { zh: "确定删除这个资产吗？", en: "Delete this asset?" },
        "smart.assetNoFolder": { zh: "请先新建一个服装素材分组", en: "Create an image folder first" },
        "smart.assetLoadFail": { zh: "素材库加载失败", en: "Failed to load assets" },
        "smart.assetAddFail": { zh: "保存资产失败", en: "Failed to save asset" },
        "smart.assetSaved": { zh: "已保存到素材库", en: "Saved to assets" },
        ...
        "smart.shortcutBoxSelect": { zh: "临时反转选择/移动模式", en: "Temporarily invert Select/Move mode" },
        ...
        "smart.shortcutPan": { zh: "选择模式框选，移动模式平移", en: "Box-select in Select mode; pan in Move mode" },
