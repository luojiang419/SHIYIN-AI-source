(function(){
    ...
    function allowsNativeContextMenu(target){
        const element = target?.closest?.('[data-native-context-menu], input, textarea, [contenteditable=""], [contenteditable="true"]');
        if(!element) return false;
        if(element.matches?.('[data-native-context-menu]')) return true;
    ...
    if(!window.RuntimeSync){
        ...
        script.src = '/static/js/runtime-sync.js?v=2026.07.23.preferences.1';
