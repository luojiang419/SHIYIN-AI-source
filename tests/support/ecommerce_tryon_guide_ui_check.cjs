...
(async () => {
    ...
    try {
        ...
        await page.locator('[data-tryon-model-description="1"]').dblclick();
        await page.locator('[data-tryon-model-description="1"] input').fill('保持这位模特的面部和身形');
        await page.locator('[data-tryon-model-description="1"] input').press('Enter');
        ...
        await upper.locator('[data-tryon-description-role]').dblclick();
        await upper.locator('.ec-tryon-description input').fill('保留米白色面料与翻领结构');
        await upper.locator('.ec-tryon-description input').press('Enter');
        ...
        await extra.locator('[data-tryon-description-role]').dblclick();
        await extra.locator('.ec-tryon-description input').fill('只参考领口织法，不改变服装版型');
        await extra.locator('.ec-tryon-description input').press('Enter');
        ...
        assert.match(await page.locator('[data-tryon-wardrobe-role="upper_garment"] [data-tryon-description-role]').textContent(),/保留米白色面料/);
