...
class EcommerceFrontendContractTests(unittest.TestCase):
    ...
    def test_ecommerce_pending_candidates_match_requested_count(self):
        ...
        self.assertIn('id="frame-ecommerce" data-src="/static/ecommerce.html?v=2026.09.09.batch-outfit-pending.1"', self.index_html)
        ...
        self.assertIn('/static/css/ecommerce.css?v=2026.09.09.batch-outfit-pending.1', self.html)
    ...
    def test_generation_parameters_render_before_slow_server_bootstrap(self):
        ...
        self.assertIn("void waitForPreferenceBootstrap().then", init_body.group(1))
        self.assertIn("preferenceBootstrapValid()", init_body.group(1))
