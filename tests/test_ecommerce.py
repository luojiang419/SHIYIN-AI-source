...
class EcommerceFrontendContractTests(unittest.TestCase):
    ...
    def test_ecommerce_pending_candidates_match_requested_count(self):
        ...
        self.assertIn('id="frame-ecommerce" data-src="/static/ecommerce.html?v=2026.09.06.batch-outfit.2"', self.index_html)
        self.assertNotIn('id="frame-free-creation"', self.index_html)
        self.assertNotIn("switchUI(this, 'free-creation')", self.index_html)
        self.assertIn('/static/js/ecommerce.js?v=2026.09.06.batch-outfit.2', self.html)
        self.assertIn('/static/css/ecommerce.css?v=2026.09.06.batch-outfit.2', self.html)
