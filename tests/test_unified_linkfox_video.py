...
const sd25=film.videoPromptSubmission(draft,{...base,model:'doubao-seedance-2-5-pro-260901'});
assert.equal(sd25.auto_adapt_prompt,true);
assert.equal(sd25.prompt_source_model,'seedance2.0');
