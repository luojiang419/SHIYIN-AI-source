...
def inject_sidebar(path: Path, active: str, batch_href: str, universal_href: str) -> None:
    page = path.read_text(encoding='utf-8')
    sidebar = build_sidebar(active, batch_href, universal_href)
...
def main() -> None:
    ...
    inject_sidebar(staging/'index.html', 'batch', 'index.html', '全能模式/index.html')
    inject_sidebar(universal_output/'index.html', 'universal', '../index.html', 'index.html')
    (staging/'使用说明.txt').write_text(
        '拾影离线培训教程\n\n'
        '1. 将整个“拾影培训教程-20260920”文件夹复制到演示电脑。\n'
        '2. 双击根目录 index.html 打开。\n'
        '3. 使用左侧教程导航切换“批量换款”和“全能模式”。\n'
