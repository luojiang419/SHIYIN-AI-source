...
<main><section id="findings"><div class="sectionhead"><span>01 / FINDINGS</span><h2>全能模式功能简述</h2></div><div class="stats"><div><b>{total}</b><span>imgx 生成任务</span></div><div><b>{succeeded} / {failed}</b><span>成功 / 失败</span></div><div><b>4K</b><span>统一请求分辨率</span></div><div><b>原生输出</b><span>未叠加应用面料增强</span></div></div>
