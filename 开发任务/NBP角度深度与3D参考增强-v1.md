...
- 2026-08-30：将左右提示改为观察者坐标和画面近侧锚点，解决左右输出高度相似问题；复测结果已出现相反侧面展开。

- 2026-08-30：再次校正负角度分支，采用人物解剖学左侧相机位和右肩近侧画面锚点；探针结果确认可生成左侧斜拍。

- 2026-08-30：完成左右 40° + 向下 45°复测，右侧复合机位命中较好，左侧仍偏正面，记录于深度参考测试报告。

- 2026-08-30：加入高机位俯视硬约束，明确光轴向下 45°和顶部平面可见，并完成左右复测。

## 阶段验收

- 2026-08-30：用户确认深度图方式正确可用。左右相机方向、向下 45°高机位和视线避开镜头均已验证；3D 导演台参考留到下一阶段。
